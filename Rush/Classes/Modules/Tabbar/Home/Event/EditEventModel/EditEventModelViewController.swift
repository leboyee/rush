//
//  EditEventModelViewController.swift
//  Rush
//
...
protocol EditEventModelViewControllerDelegate: class {
    func delete(type: String, object: Any?)
    func savePhoto(_ object: Any?)
}

class EditEventModelViewController: UIViewController {
    ...
    weak var delegate: EditEventModelViewControllerDelegate?
...
// MARK: - Actions
extension EditEventModelViewController {
