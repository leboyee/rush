...
public final class UIDotLoadingIndicator: UIView {
    ...
    @IBInspectable public var dotsRadius: CGFloat = 3.0 {
        didSet {
    ...
    @IBInspectable public var dotsSpacing: CGFloat = 5 {
        didSet {
            setNeedsLayout()
        }
    }
    ...
    override public var tintColor: UIColor! {
        didSet {
            for layer in dotLayers {
                layer.fillColor = UIColor.dotAnimationUnFillColor.cgColor
            }
        }
    }
    ...
    private func scaleAnimation(_ after: TimeInterval = 0) -> CAAnimationGroup {
        ...
        let scaleUpColor = CABasicAnimation(keyPath: "fillColor")
        scaleUpColor.beginTime = after
        scaleUpColor.fromValue = UIColor.dotAnimationUnFillColor.cgColor
        scaleUpColor.toValue = UIColor.dotAnimationFillColor.cgColor
        scaleUpColor.duration = 0.0
        ...
        let scaleDownColor = CABasicAnimation(keyPath: "fillColor")
        scaleDownColor.beginTime = after+scaleUp.duration
        scaleDownColor.fromValue = UIColor.dotAnimationFillColor.cgColor
        scaleDownColor.toValue = UIColor.dotAnimationUnFillColor.cgColor
        scaleDownColor.duration = 0.0

        let group = CAAnimationGroup()
        group.animations = [scaleUp, scaleDown, scaleUpColor, scaleDownColor]
