...
open class FullScreenSlideshowViewController: UIViewController {
    ...
    override open func viewDidLoad() {
        ...
        closeButton.setBackgroundImage(UIImage(named: "camera_close"), for: UIControlState())
    ...
    open override func viewDidLayoutSubviews() {
        if !isBeingDismissed {
            ...
            closeButton.frame = closeButtonFrame ?? CGRect(x: screenWidth - 50, y: max(15, safeAreaInsets.top+5), width: 30, height: 30)
        }
