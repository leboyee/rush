...
open class ImageSlideshow: UIView {
    ...
    open var pageIndicator: UIPageControl? = UIPageControl() {
        didSet {
...
//        }
    ...
    open func layoutPageControl() {
        if let pageIndicatorView = pageIndicator {
    ...
    func layoutScrollView() {
        let pageIndicatorViewSize = pageIndicator?.frame.size
    ...
    @objc private func pageControlValueChanged() {
        if let currentPage = pageIndicator?.currentPage {
...
extension ImageSlideshow: UIScrollViewDelegate {
    ...
    open func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        pageIndicator?.currentPage = currentPageForScrollViewPage(primaryVisiblePage)
    }
