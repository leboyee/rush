...
internal class GalleryPhotoCell: UICollectionViewCell {
    ...
    func setUpSubviews() {
        ...
        overlayView.backgroundColor = UIColor.clear // Chirag 0.3
        ...
        tagLabel.bottomAnchor.constraint(equalTo: imageView.bottomAnchor, constant: -(8 - tagLabel.frame.size.height)).isActive = true
        tagLabel.trailingAnchor.constraint(equalTo: overlayView.trailingAnchor, constant: -8).isActive = true
    }
}
