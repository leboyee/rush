...
open class TTGSnackbar: UIView {
    ...
    fileprivate static let snackbarDefaultFrame: CGRect = CGRect(x: 16, y: 0, width: 320, height: 48)
    
    /// Snackbar min height
    fileprivate static let snackbarMinHeight: CGFloat = 48
    ...
    @objc open dynamic var separateViewBackgroundColor: UIColor = UIColor.clear {
        didSet {
...
private extension TTGSnackbar {
    ...
    func configure() {
        ...
        backgroundColor = UIColor(red: 0.24, green: 0.56, blue: 0.33, alpha: 1)
        layer.cornerRadius = cornerRadius
        ...
        contentView.backgroundColor = UIColor(red: 0.24, green: 0.56, blue: 0.33, alpha: 1)
